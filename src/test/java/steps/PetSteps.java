...
public class PetSteps {
	...
	public void create_pet_api_payload() 
	{
	 ...
	 obj.setName("Doggesh Bhai");
	 
	 List <String> photourl = new ArrayList<>();
	 photourl.add("Url1String");
     ...
     reqs =  given().spec(SpecBuilder.reqSpec()).body(obj);
	...
	public void he_should_get_status_code_as(Integer int1)
	{
	    ...
	    // 2. HEADER VALIDATION
	    res.then().header("Content-Type", containsString("application/json"));
	    ...
	    Assert.assertEquals(resObj.getName(), "Doggesh Bhai");
